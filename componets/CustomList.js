        ...
        <ListItem onPress={()=>enterChat(id, chatName)} key={id} bottomDivider>
            ...
            <ListItem.Content>
                ...
                <ListItem.Subtitle ellipsizeMode="tail" numberOfLines={1}>
                    Hello John I am here to start that project we discusssed last month
                </ListItem.Subtitle>
            </ListItem.Content>
